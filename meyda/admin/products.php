...
<head>
  ...
  <style>
    ...
    * { font-family: 'Futura', system-ui, -apple-system, "Segoe UI", Roboto, 'Google Sans', Arial; }
    ...
    .form-buttons button { padding: 10px 20px; background: #ff6d00; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 500; transition: all 0.2s; font-family: 'Futura', inherit; height: 40px; display: flex; align-items: center; justify-content: center; line-height: 1; }
    .form-buttons button:hover { background: #e55d00; transform: translateY(-1px); }
    .form-buttons a { padding: 10px 20px; background: #404040; color: white; text-decoration: none; border-radius: 8px; font-weight: 500; transition: all 0.2s; font-family: 'Futura', inherit; height: 40px; display: flex; align-items: center; justify-content: center; line-height: 1; }
